...
<script>
    var domain = "https://consultingcrm.uz";
    var selecting = null
    var selected = []
    ...
    function makeProductsUI(products) {
        ...
        for (let i = 0; i < products.length; i++) {
            ...
            div += '<div class="d-none counter" id="counter'+ item.id +'">1</div>'
    ...
    mainBtn.onClick(() => {
        ...
        {
            axios.post('api/bot', {query_id:  window.Telegram.WebApp.initDataUnsafe.query_id,  user: window.Telegram.WebApp.initDataUnsafe.user, orders: selected})
                .then(response =>{
