                ...
                <div class="form-row">
                    <div class="col-md-6">
                        <div class="position-relative form-group">
                            ...
                            <input name="title" id="title" value="{{ $branch->title }}" type="text" class="form-control">
                            @error('title')
                    ...
                    <div class="col-md-6">
                        <div class="position-relative form-group">
                            ...
                            <input name="origin" id="origin" value="{{ $branch->origin }}" type="text" class="form-control">
                            @error('latitude')
                            <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
                ...
                <div class="form-row">
                    <div class="col-md-6">
                        <div class="position-relative form-group">
                            ...
                            <input name="starts" id="starts" value="{{ $branch->starts }}" type="text" class="form-control">
                            @error('starts')
                            <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-6">
                        <div class="position-relative form-group">
                            ...
                            <input name="ends" id="ends" value="{{ $branch->ends }}" type="text" class="form-control">
                            @error('ends')
                            <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
                ...
                <div class="form-row">
                    ...
                    <div class="col-md-6">
                        <div class="position-relative form-group">
                            ...
                            <input name="latitude" id="latitude" value="{{ $branch->latitude }}" type="text" class="form-control">
                            @error('latitude')
                            <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-6">
                        <div class="position-relative form-group">
                            ...
                            <input name="longitude" id="longitude" value="{{ $branch->longitude }}" type="text" class="form-control">
                            @error('longitude')
                            <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
