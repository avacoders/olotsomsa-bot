                ...
                <div class="form-row">
                    ...
                    <div class="col-md-6">
                        <div class="position-relative form-group">
                            ...
                            <input name="order" id="order" type="number" value="{{ $product->order }}" class="form-control">
                            @error('order')
                            <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-6">
                        <div class="position-relative form-group">
                            ...
                            <input name="price" id="price" type="number" value="{{ $product->price }}" class="form-control"></div>
                        @error('price')
                        <div class="text-danger">{{ $message }}</div>
                        @enderror
                    </div>
                    <div class="col-md-6">
                        <div class="position-relative form-group">
                            ...
                            <input name="unit" id="unit" type="text" value="{{ $product->unit }}" class="form-control"></div>
                        @error('unit')
                        <div class="text-danger">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-6 p-4">
                        <div class="position-relative form-group">
                            <input name="status" id="status" type="checkbox" {{ $product->status ? 'checked': '' }}>
