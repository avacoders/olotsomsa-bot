                ...
                <div class="form-row">
                    ...
                    <div class="col-md-6">
                        <div class="position-relative form-group">
                            ...
                            <input name="order" id="order" type="number" value="{{ $user->order }}" class="form-control">
                            @error('order')
                            <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-6">
                        <div class="position-relative form-group">
                            ...
                            <input name="price" id="price" type="number" value="{{ $user->price }}" class="form-control"></div>
                        @error('price')
                        <div class="text-danger">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-6 p-4">
                        <div class="position-relative form-group">
                            <input name="status" id="status" type="checkbox" {{ $user->status ? 'checked': '' }}>
